...
def session_menu():
    ...
    while True:
        ...
        create_new = input("Would you like to create a timed study session? (yes/no): ").lower().strip()
        if create_new == 'yes':
            ...
            keep = input("Is the study session you just had something you want to keep? (yes/no): ").lower().strip()
            if keep == 'yes':
            ...
            back_to_menu = input("Would you like to return to the main menu? (yes/no): ").lower().strip()
